...
int main(void)
{
  ...
  SSD1306_GotoXY (5,20);
  SSD1306_Puts ("ODLEGLOSCI", &Font_11x18, 1);
  SSD1306_GotoXY (5,40);
  SSD1306_Puts ("W CM", &Font_11x18, 1);
  SSD1306_UpdateScreen();
  HAL_Delay (3000);

  SSD1306_Clear();
  SSD1306_GotoXY (15,0);
  SSD1306_Puts ("ODLEGLOSC", &Font_11x18, 1);
  /* USER CODE END 2 */
  ...
  while (1)
  {
	...
	//wykonywanie pomiaru odleglosci
	...
	//wyswietlanie wartosc na ekranie
	itoa(value, snum, 10);
	SSD1306_GotoXY (0, 30);
